...
#### Перечень и описание возможных рисков при автоматизации.
   * Не стоит перекладывать тестирование всего продукта на автотесты. Велик шанс упустить некоторые проблемы и особые сценарии использования, например, повторяющиеся при каком-либо определенном алгоритме действий;
   * Работа с селекторами - они могут меняться в ходе обновления ПО web-продукта;
